...
import TysPrim          ( voidPrimTy, addrPrimTy ) --, intPrimTy ) -- temporalily commented out. See #8326
...
bindingOk top_lvl _ expr_ty
  | isTopLevel top_lvl = not (isUnliftedType expr_ty) || expr_ty `eqType` addrPrimTy
  | otherwise          = True
